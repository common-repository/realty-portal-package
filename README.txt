...
1. Upload `realty-portal-package` folder to the `/wp-content/plugins/` directory or install the plugin through the WordPress plugins screen directly.
...
= 0.3.3 =
* Fix bug expired package
* Improve core

= 0.3.4 = 
* Fix bug expired date
* Improve core